...
function calrpc() {
	...
	var v_mcl1_top = 23226;
	var v_mcl2_top = 29033;
	...
	var v_etp_taxfree_limit_base = 11341;
	var v_etp_taxfree_limit_yearly = 5672;
	var v_etp_cap_gr = 225000;
	...
	if (document.getElementById('super').value*1 > 30) {
		...
		document.getElementById('super').value = 10;
		}
	...
	var v_oetp = v_pln*1 + v_ggh*1 + v_opetps*1;
